<p align="center">Hello, I'm Tahmid 👋</p>
<p align="center">You can get in touch with me by emailing me <a href="mailto:tahmid@tahmid.io">here</a></p>

```ts
const tahmid = {
  education: [{ name: "Hunter College", degree: "Computer Science" }],
  experience: [
    { title: "Jr. Software Engineer", employer: "Synergy Prep", from: "Nov. 2021", to: "Present" },
    { title: "Teaching Assistant", employer: "Hunter College", from: "Aug. 2023", to: "Dec. 2023" }
  ],
  projects: [
    { name: "Codebloom", url: "https://codebloom.patinanetwork.org", repo: "https://github.com/tahminator/codebloom" },
